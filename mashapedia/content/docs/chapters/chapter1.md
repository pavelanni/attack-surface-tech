...
* [https://en.wikipedia.org/wiki/Tor*(anonymity*network)](https://en.wikipedia.org/wiki/Tor*%28anonymity*network%29)
...
* [https://en.wikipedia.org/wiki/Zero-day*(computing)](https://en.wikipedia.org/wiki/Zero-day*%28computing%29)
...
* [https://en.wikipedia.org/wiki/Exploit*(computer*security)](https://en.wikipedia.org/wiki/Exploit*%28computer*security%29)
...
* https://en.wikipedia.org/wiki/Tunneling*protocol#Secure*Shell*tunneling
...
More:
* https://link.springer.com/chapter/10.1007/978-1-4302-6572-6*6 (very good explanation; you can read a chapter, or download the whole book there -- thanks, Springer!)
* https://en.wikipedia.org/wiki/Booting#Modern*boot*loaders
* https://engineering.fb.com/2016/01/29/security/hardware-and-firmware-attacks-defending-detecting-and-responding/
* Evil maid attack: https://en.wikipedia.org/wiki/Evil*maid*attack
...
More:
* https://en.wikipedia.org/wiki/Hardware*keylogger
...
More:
* https://en.wikipedia.org/wiki/Faraday*cage
...
More:
* [https://en.wikipedia.org/wiki/Tails*(operating*system)](https://en.wikipedia.org/wiki/Tails*%28operating*system%29)
...
* https://en.wikipedia.org/wiki/MIT*Media*Lab
...
* https://en.wikipedia.org/wiki/Electroluminescent*wire
...
More:
* https://en.wikipedia.org/wiki/Altair*8800
...
More:
* [https://en.wikipedia.org/wiki/Paranoid*Android*(software)](https://en.wikipedia.org/wiki/Paranoid*Android*%28software%29)
...
More: 
* https://en.wikipedia.org/wiki/Near-field*communication
* https://nfc-forum.org/
...
More:
* https://en.wikipedia.org/wiki/Information*cascade
...
* https://en.wikipedia.org/wiki/Stingray*phone*tracker
...
* [https://en.wikipedia.org/wiki/Asterisk*(PBX)](https://en.wikipedia.org/wiki/Asterisk*%28PBX%29)
...
* https://en.wikipedia.org/wiki/Signal*Protocol
...
More:
* https://wiki.mozilla.org/Security/Binary*Transparency
...
More:
* https://en.wikipedia.org/wiki/Hash*function
...
* https://smartech.gatech.edu/bitstream/handle/1853/43766/davis*andrew*t*201205*ro.pdf (2012)
...
More:
* https://en.wikipedia.org/wiki/Man-in-the-middle*attack
...
* https://wiki.osmfoundation.org/wiki/Main*Page
...
More:
* https://citizenlab.ca/
* https://en.wikipedia.org/wiki/Citizen*Lab
